...
[_QWERTY] = LAYOUT(
        KC_Q,                   LT(BREAKPOINTS,KC_W),   LT(STEPPING,KC_E),      LT(DEBUGGING,KC_R),     KC_T,
        KC_Y,                   KC_U,                   KC_I,                   KC_O,                   KC_P,
        LT(DELETE,KC_A),        LT(TABS,KC_S),          LT(LEFT_RIGHT_NAVIGATION,KC_D),LT(SYMBOLS,KC_F),KC_G,
        KC_H,                   LT(TOOLS,KC_J),         LT(COPILOT,KC_K),       KC_L,                   LT(DEBUGGING_LAYER_SELECT, KC_DOT),
        LT(NUMS,KC_Z),          LT(MEDIA,KC_X),         LT(COPILOT, KC_C),      LT(SYMBOLS_2,KC_V),     KC_B,
        KC_N,                   LT(BOOKMARKS, KC_M),    KC_COMM,                LT(MEDIA,KC_DOT),       KC_QUOT,
